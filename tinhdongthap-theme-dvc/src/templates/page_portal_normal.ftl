...
<head>
	...
	<base href="/">
	<link href="${themeDisplay.getPathThemeRoot()}/css/base-style.css?t=888812555323" rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" type="text/css">
	<link href="${themeDisplay.getPathThemeRoot()}/css/main.css?t=82183183138123" rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" type="text/css">
	...
	<!--  -->
	<script src="${themeDisplay.getPathThemeRoot()}/js/date-time-picker.js?t=81888" defer></script>
	...
	<!-- <script src="${themeDisplay.getPathThemeRoot()}/js/mermaid.js?t=3124123" defer></script> -->
	<script>

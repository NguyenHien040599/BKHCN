...
<head>
	...
	<base href="/">
	<link href="${themeDisplay.getPathThemeRoot()}/css/main.css?t=919131931915" rel="stylesheet" type="text/css">
...
<body class="${css_class} page-theme">
	...
	<script type="text/javascript">
		...
		$(".header_login .logo img").attr("src","o/bokhoahoccongnghe-theme/images/sub-logo-2.png");
		$("#login_container .text-logo").html('<p class="text-logo-1"> Hệ thống thông tin giải quyết thủ tục hành chính </p><p class="text-logo-2"> Bộ Khoa học và Công nghệ </p>');
	</script>
	...
	<style>
		...
		.body_login {
			background: url("/o/bokhoahoccongnghe-theme/images/bg_login.jpg") center center no-repeat;
			background-size: cover;
		}

...
<head>
	<title>Đại học Quốc gia Hà Nội - Quản lý hồ sơ hành chính</title>
	...
	<link type="text/css" href="${themeDisplay.getPathThemeRoot()}/css/upgrade.css?t=71831312339987" rel="stylesheet">
...
<body class="${css_class} mBody page-theme">
	...
	<!-- inject:js -->
	<script type="text/javascript" src="/o/opencps-store/js/cli/login/app/js/chunk-vendors.js?t=98361132423"></script>
	<script type="text/javascript" src="/o/opencps-store/js/cli/login/app/js/app.js?t=983612423113666"></script>

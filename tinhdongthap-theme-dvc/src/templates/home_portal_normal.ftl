...
<head>
	...
	<base href="/">
	<link href="${themeDisplay.getPathThemeRoot()}/css/base-style.css?t=82831881" rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" type="text/css">
	<link href="${themeDisplay.getPathThemeRoot()}/css/main.css?t=88881213" rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" type="text/css">
	...
	<script type="text/javascript" src="${themeDisplay.getPathThemeRoot()}/js/jquery.min.js?t=93123123"></script>
...
<body class="${css_class} home-theme">
	...
	<div class="" id="wrapper">
		...
		<!--  -->
		<footer id="footer">
			<img alt="DVC Đồng Tháp" src="${themeDisplay.getPathThemeRoot()}/images/lotus.webp?t=3123"/> 
			...
			<p class="info">
				...
				<span class="hid">|</span>
				<span>Hỗ trợ sử dụng phần mềm: 027.7361.9999</span>
				<span class="hid">|</span>
    ...
    <script type="text/javascript" src="https://platform.epacific.net/js/64b6b6268ff1192f6e02c5b8/chatbot.js"></script>
    <script type="text/javascript" >
		window.pid = '64b6b6268ff1192f6e02c5b8';
		window.pkey = 'CT-Kc9i_GrkGe_zUE_WkG8pD0dz_H6md';
		if (window.themeDisplay.isSignedIn()) {
			window.userid = window.themeDisplay.getUserId();
			try {
				var userLogin = JSON.parse(localStorage.getItem("userInfo"));
				window.username = userLogin['userName']
			} catch (error) {
				window.username = window.themeDisplay.getUserName()
			}
		} else {
			window.userid = '';
			window.username = '';
	...
	<style>
		...
		.home-theme {
			background: url("/o/tinhdongthap-theme/images/main-bg.webp") center center no-repeat;

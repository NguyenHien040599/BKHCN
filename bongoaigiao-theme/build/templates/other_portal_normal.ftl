...
<head>
	...
	<link type="text/css" href="${themeDisplay.getPathThemeRoot()}/css/upgrade.css?t=2127839987" rel="stylesheet">
...
<body class="${css_class} mBody page-theme login-motcua">
	...
	<script type="text/javascript">		
		$(document).ready(function() {
			...
			$(".header_login .logo img").attr("src","o/bongoaigiao-theme/images/logo-login-motcua.png");
	...
	<style>
		...
		.body_login {
			background: url("/o/bongoaigiao-theme/images/bg_login_motcua.jpg") center center no-repeat;
		...
		.body_login #footer {
			background: rgba(3,110,218,0.7) none;
		}
		.body_login #footer .info-wrapper {
			margin-bottom: 0;
		}
		...
		.body_login #login_container form > div:nth-child(-n+2) .v-input__slot {
			background-color: white !important;
		}
		.body_login #login_container form > div:nth-child(3) {
			display: flex;
			flex-wrap: wrap;
			justify-content: center;
		}
		.body_login #login_container form > div:nth-child(3) > div {
			width: 100%;
			margin: 0 0 10px;
			order: 1;
		}
		.body_login #login_container form > div:nth-child(3) > button {
			order: 2;
			padding: 8px 15px;
			height: auto;
			border-radius: 6px;

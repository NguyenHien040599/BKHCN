...
<head>
	...
	<link href="${themeDisplay.getPathThemeRoot()}/css/main.css?t=88312388" rel="stylesheet" type="text/css">
...
<body class="${css_class} home-theme">
	...
	<style>
		...
		.home-theme {
			background: url("/o/bocongan-theme/images/main-bg.jpg") center center no-repeat;
